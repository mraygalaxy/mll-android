...
android.add_jars = %(source.dir)s/jars/couchbase-lite-java-core-1.3.0.jar,%(source.dir)s/jars/couchbase-lite-java-javascript-1.3.0.jar,%(source.dir)s/jars/couchbase-lite-java-listener-1.3.0.jar,%(source.dir)s/jars/rhino-1.7R3.jar,%(source.dir)s/jars/commons-io-2.0.1.jar,%(source.dir)s/jars/jackson-core-2.5.0.jar,%(source.dir)s/jars/jackson-annotations-2.5.0.jar,%(source.dir)s/jars/jackson-databind-2.5.0.jar,%(source.dir)s/jars/servlet-2-3.jar,%(source.dir)s/jars/webserver-2-3.jar,%(source.dir)s/jars/stateless4j-2.4.0.jar,%(source.dir)s/jars/okio-1.8.0.jar,%(source.dir)s/jars/okhttp-3.3.1.jar,%(source.dir)s/jars/couchbase-lite-android-1.3.0.jar,%(source.dir)s/jars/couchbase-lite-android-forestdb-1.3.0.jar,%(source.dir)s/jars/couchbase-lite-android-sqlcipher-1.3.0.jar,%(source.dir)s/jars/couchbase-lite-android-sqlite-custom-1.3.0.jar,%(source.dir)s/jars/play-services.jar,%(source.dir)s/jars/android-support-v4.jar,%(source.dir)s/jars/play-services-gcm.jar,%(source.dir)s/jars/play-services-iid.jar,%(source.dir)s/jars/play-services-basement.jar,%(source.dir)s/jars/commons-compress-1.12.jar
